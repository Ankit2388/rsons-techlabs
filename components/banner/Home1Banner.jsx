          ...
          <div className="row">
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                ...
                <p>
                  Join us as we carve a path to success, driven by passion, powered by innovation,
                  and fueled by the collective spirit of our team. we believe in the power of bold
                  ideas, and we're here to turn them into reality.{' '}
                </p>
                <div className="banner-content-bottom">
                  <Link href="/contact" className="primary-btn1" data-text="Free Consultation">
